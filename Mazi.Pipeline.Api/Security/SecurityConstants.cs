...
public static partial class SecurityConstants
{
   ...
   public const string Claim_X_MsClientPrincipalIdp =
      "X-MS-CLIENT-PRINCIPAL-IDP";
   public const string Claim_X_MsClientPrincipalName =
   ...
   public const string Policy_LoggedInUsingEasyAuth =
      "LoggedInUsingEasyAuthHandler";
