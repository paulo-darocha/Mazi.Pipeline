...
public class SecurityConfiguration : ISecurityConfiguration
{
   public SecurityConfiguration(IConfiguration configuration)
   {
      ...
      PostLoginPath = configuration.GetValue<string>(
         "SecuritySettings:PostLoginPath"
      );
      PostLogoutPath = configuration.GetValue<string>(
         "SecuritySettings:PostLogoutPath"
      );
      UserAccountPath = configuration.GetValue<string>(
         "SecuritySettings:UserAccountPath"
      );
      RegisterPath = configuration.GetValue<string>("SecuritySettings:RegisterPath");
      DevelopmentMode = configuration.GetValue<bool>(
         "SecuritySettings:DevelopmentMode"
      );
      AzureActiveDirectory = configuration.GetValue<bool>(
         "SecuritySettings:AzureActiveDirectory"
      );
      Google = configuration.GetValue<bool>("SecuritySettings:Google");
      MicrosoftAccount = configuration.GetValue<bool>(
         "SecuritySettings:MicrosoftAccount"
      );
